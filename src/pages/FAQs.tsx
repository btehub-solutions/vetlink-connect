...
const faqs = [
  ...
  { q: "What areas do you serve?", a: "We currently operate in Lagos and Abuja, with plans to expand. However, we can arrange product delivery to most locations across Nigeria. Contact us via WhatsApp to confirm delivery to your area.", icon: "📍" },
  { q: "How quickly can I get products?", a: "Delivery times vary by location. For Lagos and Abuja, most orders are fulfilled within 24-48 hours. For other areas, please allow 3-5 business days. Emergency supplies are prioritized.", icon: "🚚" },
